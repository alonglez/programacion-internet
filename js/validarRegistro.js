        ...
        document.getElementById('registrar').onclick = function  () {
          ...
          //Validar Apellidos
            ...
            //Validar Usuario
              if( usuario.value == null || usuario.value.length == 0 || /^\s+$/.test(usuario.value)  ) {
                swal("","El nombre de usuario no puede estar vacío.","error").then(function () {
                  usuario.focus();
                ...
                swal("","El nombre de usuario debe ser de por lo menos 4 caracteres.","error").then(function () {
                  usuario.focus();
                  usuario.style.backgroundColor = '#FF0000';
                  window.scroll(0,findPos(document.getElementById("usuario"))-100);
                  });
                ...
                swal("","El nombre de usuario admite solo letras mayúsculas, minúsculas, números y guiones bajos.","error").then(function () {
                  usuario.focus();
                  usuario.style.backgroundColor = '#FF0000';
                  window.scroll(0,findPos(document.getElementById("usuario"))-100);
                  });
          ...
          //Validar Contrasena
            if( contrasena.value == null || contrasena.value.length == 0 ) {
              swal("","El campo de la contraseña no puede estar vacío.","error").then(function () {
                contrasena.focus();
              ...
              swal("","La contraseña debe ser de por lo menos 6 caracteres.","error").then(function () {
                contrasena.focus();
                contrasena.style.backgroundColor = '#FF0000';
                window.scroll(0,findPos(document.getElementById("contrasena"))-100);
                });
          ...
          //Validar Correo
            ...
            //Validar Confirmacion Correo
              if( correoConfirmacion.value == null || correoConfirmacion.value.length == 0 || /^\s+$/.test(correoConfirmacion.value) ) {
                swal("","Debes confirmar tu correo.","error").then(function () {
                ...
                swal("","Los correos no coinciden.","error").then(function () {
                  correoConfirmacion.focus();
                  correoConfirmacion.style.backgroundColor = '#FF0000';
                  window.scroll(0,findPos(document.getElementById("correoConfirmacion"))-100);
                  });
